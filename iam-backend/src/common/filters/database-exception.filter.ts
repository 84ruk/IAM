  ...
  export class DatabaseExceptionFilter implements ExceptionFilter {
    private readonly logger = new Logger(DatabaseExceptionFilter.name);
      ...
      if (exception instanceof InsufficientStockException ||
        ...
        status = exception instanceof ProductNotFoundException ? HttpStatus.NOT_FOUND : HttpStatus.BAD_REQUEST;
      ...
      // Excepciones estándar de NestJS
        ...
        details = {
          ...
          originalError: process.env.NODE_ENV === 'development' ? badRequestResponse.message : undefined,
          ...(badRequestResponse.details && { details: badRequestResponse.details }),
        };
      }
        ...
        details = {
          code: 'FORBIDDEN',
          suggestion: 'Verifica que tengas los permisos necesarios para realizar esta acción',
          originalError: process.env.NODE_ENV === 'development' ? forbiddenResponse.message : undefined,
          ...(forbiddenResponse.details && { details: forbiddenResponse.details }),
        };
      }
        ...
        switch (exception.code) {
          ...
          case 'P2025':
            ...
            details = {
              ...
              suggestion: 'Verifica que el ID o criterios de búsqueda sean correctos',
            };
            break;
          case 'P2003':
            status = HttpStatus.BAD_REQUEST;
          ...
          default:
            ...
            details = {
              code: exception.code,
              suggestion: 'Verifica los datos enviados',
              ...(process.env.NODE_ENV === 'development' && { originalError: exception.message }),
            };
        }
      }
      ...
      // Errores generales
        ...
        if (message.includes('connect') || message.includes('ECONNREFUSED')) {
          ...
          details.suggestion = 'Verifica que el servicio de base de datos esté ejecutándose';
        }
      }
      ...
      this.logger.error(`Error response: ${JSON.stringify(errorResponse, null, 2)}`);
